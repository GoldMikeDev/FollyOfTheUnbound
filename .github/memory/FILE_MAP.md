...
| `scripts/` | Active | Manually-invoked scripts not used by the build process (per its own `README.md`). Includes `test-folly-cleanse.sh`, a standalone manual test harness for `folly.sh cleanse` — see `TESTING_STRATEGY.md`. |
